...
import {navbar, courses, transport} from '../../../../shared/constants.ts';
        ...
        <div className='footer-body__wrapper'>
          <div className='footer-body__row'>
            <div className='footer-body__row_transport'>
                ...
                <defs>
                <clipPath id="clip0_34927_1944">
                <rect width="130" height="22" fill="white"/>
                </clipPath>
                </defs>
              </svg>
              
              <p>Createx Online School is a leader in online studying.
              ...
              <ul>
                {
                  transport.map((item: string, index:number)=>{
                    const image: string = require(`../../../../shared/assets/icons/transport/${item}`);
                    return <li key={index}>
                      <Link to={'/'}>
                        <img src={image} alt={item.substring(2)} />
                      </Link>
                    </li>
                  })
                }
            ...
            <div className='footer-body__siteMap'>
              <h3>SITE MAP</h3>
              <ul>
                {
                  navbar.map((item: string, index: number)=>{
                    return <li key={index}>
                      <Link to={index === 0 ? 'about': item.toLowerCase()}>{item}</Link>
                    </li>
                  })
                }
              </ul>
            ...
            <div className='footer-body__signUp'>
